  ...
  <div class="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
    <div class="max-w-md w-full">
      ...
      <div class="text-center mb-8">
        ...
        <h1 class="text-3xl font-bold text-gray-900 mb-2">Reader App</h1>
        <p class="text-gray-600">Đăng nhập để bắt đầu đọc truyện</p>
      </div>
      ...
      <div class="bg-white rounded-2xl shadow-xl p-8">
        <div class="space-y-6">
          ...
          >
            ...
            <div v-if="isLoading" class="w-5 h-5 mr-3 border-2 border-gray-300 border-t-blue-600 rounded-full animate-spin"></div>
            <span class="font-medium">{{ isLoading ? 'Đang chuyển hướng...' : 'Đăng nhập với Google' }}</span>
          </button>
      ...
      <div class="text-center mt-8">
        <p class="text-sm text-gray-500">
          © 2024 Reader App. Tất cả quyền được bảo lưu.
        </p>
      </div>
    </div>
  </div>
